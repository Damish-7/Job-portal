...
import DashEditUsers from './pages/admin/DashEditUsers';
...
const DashAdminEditUserHOC = Layout(DashEditUsers);
const DashAdminEditJobTypeHOC = Layout(DashEditCategory)
                ...
                <ProSidebarProvider>
                    <BrowserRouter>
                        <Routes>
                            ...
                            <Route path='/admin/edit/category/:id' element={<AdminRoute><DashAdminEditJobTypeHOC /></AdminRoute>} />
